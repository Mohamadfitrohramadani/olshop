...
<script src="<?= base_url() ?>template_admin/plugins/datatables-buttons/js/dataTables.buttons.min.js"></script>
<script src="<?= base_url() ?>template_admin/plugins/datatables-buttons/js/buttons.bootstrap4.min.js"></script>
<script src="<?= base_url() ?>template_admin/plugins/jszip/jszip.min.js"></script>
<script src="<?= base_url() ?>template_admin/plugins/pdfmake/pdfmake.min.js"></script>
<script src="<?= base_url() ?>template_admin/plugins/pdfmake/vfs_fonts.js"></script>
<script src="<?= base_url() ?>template_admin/plugins/datatables-buttons/js/buttons.html5.min.js"></script>
<script src="<?= base_url() ?>template_admin/plugins/datatables-buttons/js/buttons.print.min.js"></script>

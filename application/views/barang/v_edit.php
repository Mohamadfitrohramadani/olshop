<div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" placeholder="Deskripsi Produk" cols="20" rows="6">
                            <?= $barang->deskripsi ?></textarea>
                    </div>
                    <div class="col-sm-6">
                    <div class="form-group">
                        <label>Gambar Barang</label>
                        <input name="gambar" class="form-control" type="file" id="preview_gambar">
                        </div>
                    </div>
                   <div class="col-sm-5">
                    <div class="mb-3">
